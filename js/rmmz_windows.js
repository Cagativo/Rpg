...
Window_MenuCommand.prototype.makeCommandList = function() {
    ...
    this.addSaveCommand();
    this.addQuestsCommand(); // Add this line to include the Quests command
...
Window_MenuCommand.prototype.addQuestsCommand = function() {
    if (this.needsCommand("quests")) {
        const enabled = this.isQuestsEnabled(); // Check if the quests feature is enabled
        this.addCommand(TextManager.quests, "quests", enabled);
    }
};
...
Window_MenuCommand.prototype.needsCommand = function(name) {
    const table = ["item", "skill", "equip", "status", "formation", "save", "quests"];
...
Window_MenuCommand.prototype.isQuestsEnabled = function() {
    // Add logic to determine if the Quests command should be enabled
    //return $gameSystem.hasQuests() && !$gameSystem.isQuestMenuDisabled();
    return true;
};
